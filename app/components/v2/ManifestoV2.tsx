...
import { Reveal, StaggerReveal } from "./useScrollEffects";
...
const ManifestoV2: React.FC = () => (
  <section className="py-16 lg:py-[88px] text-center">
    <div className="max-w-[1200px] mx-auto px-6 lg:px-12">
      ...
      <Reveal>
        <blockquote className="font-freight text-[clamp(1.35rem,2.6vw,1.9rem)] font-normal leading-[1.42] max-w-[680px] mx-auto mb-8 text-white italic">
          Plenty of funds write checks. We put founders in a room with the people
          who built the companies they admire — and don&apos;t let them leave until
          they&apos;re ready.
        </blockquote>
      </Reveal>
      <Reveal delay={150}>
        <p className="text-white/60 text-[0.85rem] max-w-[540px] mx-auto leading-relaxed">
          The cohort is the product. 10 days of intensive training, peer accountability,
          and direct access to the operators and investors who matter — in the city
          where American hard tech is being built.
        </p>
      </Reveal>
