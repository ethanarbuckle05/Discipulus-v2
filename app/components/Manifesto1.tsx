...
//       <div className="font-light text-md mt-16">
//         <div className="flex flex-col items-center">
//           <div className="border-opacity-75 border-dashed border-[#aaa] h-[50px] w-[2px] top-0 border-0 justify-center visible bg-gradient-to-b from-black to-teal-600 mt-16" />
//           <div className="w-[40px] h-[40px] rounded-full bg-[#aaa] flex justify-center items-center bg-gradient-to-tr from-teal-200 to-teal-600">
//             <p className="text-center text-xl text-black font-bold text-[12px]">
//               1
//             </p>
...
//   It doesn’t encourage real innovation but instead repetition (primarily
//   in software) – driven by corporate interests who want this talent for
//   themselves. Undergraduate founders then mimic these founders who’ve
//   been encouraged to work in these industries.
// </p>
// <p className="mt-4 text-gray-400">
//   Technology has destroyed virtuous third places (making money the chief
//   motivator for young entrepreneurs), and we believe this mimetic trend
//   is rooted in this broader issue.
// </p>
// <p className="mt-4 text-gray-400">
//   Ideals that once spurred innovation and societal growth – religion,
//   patriotism, family – have since lost their appeal, particularly at
//   academic institutions.
// </p>
// <p className="mt-4 text-gray-400">
//   We believe universities are failing to create these virtuous third
//   places, specifically for young people who hope to become the next
